original source: https://forum.obsidian.md/t/caret-cursor-thickness/48969/9

```CSS
/* Customization amogus for the Ninja Cursor */  
.x-cursor {
  position: inline block;
  background: #A09CB4; /* Sets the Ninja Cursor Colour. */
  width: 3px; /* Sets the width of the Ninja Cursor. */ 
  transition: all 100ms !important; /* Sets the animation delay of the Ninja Cursor. Fast typers should use a higher delay to maintain the effect. */ 
...
```CSS
/*17/07/25 - block cursor*/
.x-cursor {
  position: inline block;
  background: transparent;
  border: solid #A09CB4; /*added this*/
  border-width: 1px; /*added this*/
  width: calc(var(font-width) + 5px); /*changed this*/
  transition: all 100ms !important; 
  top: calc(0px - var(--header-height));
  --cursor-height: calc(var(font-size) + 5px); /*changed this*/
