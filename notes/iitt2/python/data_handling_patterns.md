...
## Filtering 
||Selecting based on a criterion||
...
## Mapping
||Applying the same operation to different items||
...
## Filter and Map
||Applying an operation to selected items||
...
||Accumulating a result with selected items||
